...
public class NewTest {
	...
	// NewTest screenshot=new NewTest();
	// WebDriver driver;
	...
	public void test5_NavigateToHome() throws InterruptedException,
		...
		List<WebElement> Play_Stop = driver.findElements(By
				.id("android:id/action0"));
		Play_Stop.get(1).click();
		driver.navigate().back();*/
	...
	@Test
	public void test9_Logout() throws InterruptedException {
